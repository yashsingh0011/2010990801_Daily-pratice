...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"          XAVIERS COLLEGE OF SCIENCE AND TECHNOLOGY"<<endl;
        cout<<"\t\t "<<r6<<" XAVIERS "<<r6<<"             FACULTY OF ENGINEERING AND TECHNOLOGY,\n";
        cout<<" \t\t "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                         CHURCHGATE.\n";
        cout<<" \t\t                              Accredited with Grade A by NAAC,\n";
        cout<<" \t\t                          Education Department, Govt. of Maharashtra.\n\n";
        for(int i=0;i<118;i++)
        cout<<r7;
        cout<<endl;
        home();
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<66;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"     XAVIERS UNIVERSITY OF SCIENCE AND TECHNOLOGY   "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" XAVIERS "<<r6<<"        FACULTY OF ENGINEERING AND TECHNOLOGY,      "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    CHURCHGATE.                  "<<r6<<endl;
        cout<<"\t"<<r6<<"                          Accredited with Grade A by NAAC,        "<<r6<<endl;
        cout<<"\t"<<r6<<"                      Education Department, Govt. of Maharashtra.    "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
        ...
        case 0:
            {
                ...
                system("cls");
                cout<<"\n\n\tPREPARED BY:-"<<endl;
                cout<<"\n\t"<<x<<" Arunima Bahl 2010990827";
                cout<<"\n\t"<<x<<" Yashpreet Singh 2010990801";
                cout<<"\n\t"<<x<<" Akshay Kumar 2010990817 ";
                //cout<<"\n\t"<<x<<" ";
                //cout<<"\n\t"<<x<<"  \n\n\n\n\n";
                getch();
                goto E;
